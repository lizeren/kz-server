...
public plugin_init()
{
	...
	register_cvar("cm_connect_string","%name%steamid has connected from %city, %country.")
	register_cvar("cm_disconnect_string","%name%steamid has disconnected from %city, %country.")
